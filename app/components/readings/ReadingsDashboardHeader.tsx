...
export function ReadingsDashboardHeader() {
  return (
    <header className="relative z-[1] flex flex-col gap-4">
      <div className="min-w-0 w-full max-w-full md:max-w-[66vw]">
        <h1
        ...
        >
          I am living in a long apartment in Bushwick that has windows that face southeast and northwest. I've installed LDR + ESP32 sensors on these windows, which sends light readings over my home network to a local server that writes to a database. This website shows the light readings collected overtime from these sensors. These lux values are then converted to music data in my studio.
        </p>
        <a
          href="https://miks.cafe/docs/physical-immersive/lux-2-signal"
          className="text-sm italic hover:underline"
          style={{
            color: "var(--ethereal-dusk-violet)",
            fontFamily: "var(--font-archivo), serif",
          }}
        >
          📝 Docs
